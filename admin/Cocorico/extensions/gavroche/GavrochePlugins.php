...
if (!function_exists('gavrocheEditorComponent')) {
	function gavrocheEditorComponent($component, $options = array())
	{
...
CocoDictionary::register(CocoDictionary::COMPONENT, 'editor', 'gavrocheEditorComponent');
