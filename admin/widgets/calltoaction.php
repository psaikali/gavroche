...
class IntroCalltoAction extends WP_Widget{
	...
	public function __construct(){
		parent::__construct(
			...
			'IntroCalltoAction',
			__('Gavroche - Call to action', 'gavroche'),
			array('description'=>__('Add a call to action in the sidebar.', 'gavroche'))
		);
	}
	...
	public function form($instance){
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'gavroche' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'description' ); ?>"><?php _e( 'Call to action incentive:', 'gavroche' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link' ); ?>"><?php _e( 'Call to action destination (url):', 'gavroche' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'label' ); ?>"><?php _e( 'Button\'s label:' , 'gavroche' ); ?></label>
 ...
 * @return void
 */
if (!function_exists('gavroche_calltoaction_widget_init')){

	function gavroche_calltoaction_widget_init(){
	
		register_widget('IntroCalltoAction');
	}
}
add_action('widgets_init', 'gavroche_calltoaction_widget_init');
