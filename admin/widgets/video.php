...
class IntroVideo extends WP_Widget{
	...
	public function __construct(){
		parent::__construct(
			...
			'IntroVideo',
			__('Gavroche - Video', 'gavroche'),
			array('description'=>__('Add a video from Youtube, Dailymotion or Vimeo.', 'gavroche'))
		);
	}
	...
	public function widget($args, $instance){
		...
		?>
				...
				<?php }else{ ?>
					...
					<p><?php _e('To display a video, please add a Youtube, Dailymotion or Vimeo URL in the widget settings.', 'gavroche'); ?></p>
	...
	public function form($instance){
		...
		if ($this->error){
			...
			_e('Please enter a valid url', 'gavroche');
			echo '</div>';
		}
		
		if ($this->novideo){
			echo '<div class="error">';
			_e('This video url doesn\'t seem to exist.', 'gavroche');
			echo '</div>';
		}
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'video_link' ); ?>"><?php _e( 'Video URL (Youtube, Dailymotion or Vimeo):', 'gavroche' ); ?></label>
 ...
 * @return void
 */
if (!function_exists('gavroche_video_widget_init')){

	function gavroche_video_widget_init(){
	
		register_widget('IntroVideo');
	}
}
add_action('widgets_init', 'gavroche_video_widget_init');
